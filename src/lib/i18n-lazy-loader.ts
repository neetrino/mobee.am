  ...
  switch (lang) {
    case 'en':
      switch (namespace) {
        ...
        case 'credit-terms': return () => import('../locales/en/credit-terms.json');
    ...
    case 'hy':
      switch (namespace) {
        ...
        case 'credit-terms': return () => import('../locales/hy/credit-terms.json');
    ...
    case 'ru':
      switch (namespace) {
        ...
        case 'credit-terms': return () => import('../locales/ru/credit-terms.json');
