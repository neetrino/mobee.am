...
export function ProfileDeleteAccount({ t, variant = 'sidebar' }: ProfileDeleteAccountProps) {
  ...
  const sidebarButtonClass =
    'mt-2 flex w-full items-center gap-3 rounded-[15px] border border-red-200 bg-white px-4 py-3 text-left text-sm font-medium text-red-600 transition-colors hover:bg-red-50';
